...
\begin{flalign}
&w_{Hf3dB} = w_{H3dB}(1+A^{'}\beta)  = 91.3083*2\pi*10^3*(1+\frac{1}{100k\Omega}(637.786k\frac{V}{A})) = \boxed{366.476M \frac{rad}{s}}\nonumber\\
...
we eventually find:
\begin{flalign}
&R_{if} = R_{in}(1+A^{'}\beta) = 2.569k\Omega(1+\frac{1}{100k\Omega}(637.786k\frac{V}{A})) =\boxed {18.95372234k\Omega}\nonumber \\
