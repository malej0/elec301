...
Amount of feedback measured and calculated values:

\begin{table}[h!]
    \centering
    \begin{tabular}{lll}
   
    $R_f(\Omega)$ & \begin{tabular}[c]{@{}l@{}}Predicted\\ A.o.F.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Measured \\ A.o.F\end{tabular} \\ \cline{1-3}
    10k & 64.779 & 95.991 \\ 
    100k & 7.37786 & 9.644 \\
    1M & 1.634 & 0.965
    \end{tabular}
...
predicted continue to decrease as $R_f$ increases. 
